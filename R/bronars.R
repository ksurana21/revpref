...
#' axiom if the data is generated by irrational behavior. Following Bronars' (1987) approach, we measure the
...
#' exhausted. Bronars' power measures probability of rejecting the null hypothesis that the random consumer is making
#' utility maximizing choices. Essentially, Bronars' power is the fraction of times the simulated data fails to pass
...
#'
#' @return This function returns \code{power} which computes the power of the given axiom against uniformly
