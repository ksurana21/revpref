...
#' test of consistency with strict WARP conditions.
#'
#' @return The function returns two elements. The first element \code{passwarp} is a binary indicator for
#' consistency of the data set with WARP at efficiency level \eqn{e}. It takes a value 1 if the data set
...
#' consistent \code{nviol} is 0. Further, the maximum number of violations in a \eqn{e}WARP inconsistent data is
#' \eqn{T(T-1)/2}.
#'
#' @section Definitions:
